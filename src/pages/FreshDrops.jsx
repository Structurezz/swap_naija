...
function DropHero({ total, isLoading }) {
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-[#051a10] via-[#082b1a] to-[#030f09]">
      {/* Ambient glows */}
      <div className="pointer-events-none absolute -top-16 -right-16 w-72 h-72 rounded-full bg-emerald-500/20 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-10 left-10 w-48 h-48 rounded-full bg-teal-500/15 blur-2xl" />
      <div className="pointer-events-none absolute top-1/2 right-1/3 w-24 h-24 rounded-full bg-green-300/10 blur-xl" />

      {/* Floating decoration */}
      <div className="pointer-events-none absolute right-6 top-1/2 -translate-y-1/2 opacity-10 lg:opacity-15">
        <Zap size={140} className="text-emerald-300" />
      </div>
